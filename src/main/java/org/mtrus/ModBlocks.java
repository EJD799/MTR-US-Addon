...
public final class ModBlocks {
    ...
    public static void registerModBlocks(Registry registry) {
        ...
        NYC_SUBWAY_BENCH_4A = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJBlock(createDefaultBlockSettings(false).nonOpaque(), "mtrus:obj/nyc_subway_bench_4a.obj", 0, new double[][]{{0, 7, 0, 16, 13, 16}})),
                ModCreativeModeTabs.MAIN
        );

        NYC_SUBWAY_BENCH_4B = registry.registerBlockWithBlockItem(
                new Identifier(MTRUSAddon.MOD_ID, "nyc_subway_bench_4b"),
                () -> new Block(new OBJBlock(createDefaultBlockSettings(false).nonOpaque(), "mtrus:obj/nyc_subway_bench_4b.obj", 0, new double[][]{{0, 7, 0, 16, 13, 16}})),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_1_ENTRANCE = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_1_entrance_closed.obj", "mtrus:obj/nyc_subway_fare_gate_1_entrance_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, true)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_1_EXIT = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_1_exit_closed.obj", "mtrus:obj/nyc_subway_fare_gate_1_exit_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, false)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_2_ENTRANCE = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_2_entrance_closed.obj", "mtrus:obj/nyc_subway_fare_gate_2_entrance_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, true)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_2_EXIT = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_2_exit_closed.obj", "mtrus:obj/nyc_subway_fare_gate_2_exit_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, false)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_3_ENTRANCE = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_3_entrance_closed.obj", "mtrus:obj/nyc_subway_fare_gate_3_entrance_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, true)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_3_EXIT = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_3_exit_closed.obj", "mtrus:obj/nyc_subway_fare_gate_3_exit_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, false)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_4_ENTRANCE = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_4_entrance_closed.obj", "mtrus:obj/nyc_subway_fare_gate_4_entrance_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, true)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_4_EXIT = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_4_exit_closed.obj", "mtrus:obj/nyc_subway_fare_gate_4_exit_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, false)),
                ModCreativeModeTabs.MAIN
        );
        ...
        NYC_SUBWAY_FARE_GATE_5_ENTRANCE = registry.registerBlockWithBlockItem(
                ...
                () -> new Block(new OBJFareGate("mtrus:obj/nyc_subway_fare_gate_5_entrance_closed.obj", "mtrus:obj/nyc_subway_fare_gate_5_entrance_open.obj", new double[][]{{0, 0, 0, 3, 16, 16}, {13, 0, 0, 16, 16, 16}}, true)),
                ModCreativeModeTabs.MAIN
        );
