...
public class BlockDCMetrobusStationName extends BlockExtension implements IBlock, DirectionHelper, BlockWithEntity {

    public BlockDCMetrobusStationName(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos pos, BlockState state) {
        return new BlockDCMetrobusStationNameEntity(pos, state);
    }
