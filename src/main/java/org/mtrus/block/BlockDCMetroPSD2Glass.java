...
public class BlockDCMetroPSD2Glass extends BlockAPGGlass {
    @Override
    public Item asItem2() {
        return ModItems.DC_METRO_PSD_2_GLASS.get();
    }

    @Override
    public BlockEntityExtension createBlockEntity(BlockPos blockPos, BlockState blockState) {
        return new BlockDCMetroPSD2GlassEntity(blockPos, blockState);
    }
