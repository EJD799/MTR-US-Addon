...
public class BlockNYCSubwayStationNameEntrance extends BlockExtension implements IBlock, DirectionHelper, BlockWithEntity {

    public BlockNYCSubwayStationNameEntrance(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos pos, BlockState state) {
        return new BlockNYCSubwayStationNameEntranceEntity(pos, state);
    }
