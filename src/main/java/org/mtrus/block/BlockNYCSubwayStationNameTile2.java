...
public class BlockNYCSubwayStationNameTile2 extends BlockExtension implements IBlock, DirectionHelper, BlockWithEntity {

    public BlockNYCSubwayStationNameTile2(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos pos, BlockState state) {
        return new BlockNYCSubwayStationNameTile2Entity(pos, state);
    }
