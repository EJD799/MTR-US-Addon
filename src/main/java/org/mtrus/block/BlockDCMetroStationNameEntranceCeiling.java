...
public class BlockDCMetroStationNameEntranceCeiling extends BlockExtension implements IBlock, DirectionHelper, BlockWithEntity {

    public BlockDCMetroStationNameEntranceCeiling(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos pos, BlockState state) {
        return new BlockDCMetroStationNameEntranceCeilingEntity(pos, state);
    }
