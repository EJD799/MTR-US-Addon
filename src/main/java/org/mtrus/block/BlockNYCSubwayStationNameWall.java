...
public class BlockNYCSubwayStationNameWall extends BlockExtension implements IBlock, DirectionHelper, BlockWithEntity {

    public BlockNYCSubwayStationNameWall(BlockSettings blockSettings) {
        super(blockSettings);
    }
    ...
    public BlockEntityExtension createBlockEntity(BlockPos pos, BlockState state) {
        return new BlockNYCSubwayStationNameWallEntity(pos, state);
    }
