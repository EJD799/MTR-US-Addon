...
public class BlockDCMetroNewLEDPIDSEntity extends PIDSBlockEntity {

    public BlockDCMetroNewLEDPIDSEntity(BlockPos blockPos, BlockState blockState) {
        super(ModBlockEntityTypes.DC_METRO_NEW_LED_PIDS.get(), blockPos, blockState);
    }
