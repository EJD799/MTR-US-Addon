...
public class BlockDCMetroSystemMap2 extends Vertical2Block {

    private final double[][] boxes1 = {{0, 0, 7.5, 16, 16, 8.5}};
    private final double[][] boxes2 = {{0, 0, 7.5, 16, 11.5, 8.5}};


    public BlockDCMetroSystemMap2(BlockSettings blockSettings) {
        super(blockSettings);
    }
