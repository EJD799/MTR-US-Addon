...
public class RenderDCMetroNewLEDPIDS extends PIDSRenderer<BlockDCMetroNewLEDPIDSEntity> {
    @SuppressWarnings("deprecation")
    public RenderDCMetroNewLEDPIDS(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void renderPIDS(BlockDCMetroNewLEDPIDSEntity blockEntity, PIDSPresetBase pidsPreset, GraphicsHolder graphicsHolder, StoredMatrixTransformations storedMatrixTransformations, World world, BlockState state, BlockPos pos, Direction facing, LongImmutableList targetPlatformIds, ObjectArrayList<ArrivalResponse> arrivals, float tickDelta, boolean[] rowHidden, int light) {
