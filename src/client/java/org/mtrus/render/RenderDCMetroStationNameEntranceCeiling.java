...
public class RenderDCMetroStationNameEntranceCeiling extends BlockEntityRenderer<BlockDCMetroStationNameEntranceCeilingEntity> implements IGui {
    ...
    public RenderDCMetroStationNameEntranceCeiling(BlockEntityRenderer.Argument dispatcher) {
        super(dispatcher);
    }

	@Override
    public void render(BlockDCMetroStationNameEntranceCeilingEntity entity, float tickDelta,
        ...
        MainRenderer.scheduleRender(CIRCLE_TEXTURE, false,
                ...
                (graphicsHolderNew, offset) -> {
                    ...
                    IDrawing.drawStringWithFont(graphicsHolderNew, stationName, HorizontalAlignment.CENTER, VerticalAlignment.CENTER, 0, -0.05F, 4, 0.25F, 0.04F, ARGB_BLACK, false, light, null);	
