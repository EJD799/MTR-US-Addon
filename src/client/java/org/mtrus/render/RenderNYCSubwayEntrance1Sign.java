...
public class RenderNYCSubwayEntrance1Sign extends BlockEntityRenderer<BlockNYCSubwayEntrance1SignEntity> implements IGui {
    ...
    public RenderNYCSubwayEntrance1Sign(BlockEntityRenderer.Argument dispatcher) {
        super(dispatcher);
    }

	@Override
    public void render(BlockNYCSubwayEntrance1SignEntity entity, float tickDelta,
                ...
                (graphicsHolderNew, offset) -> {
					...
					for (ArrayList<Object> route : routes) {
						IDrawing.drawTexture(
                            graphicsHolderNew,
                            -0.55F + (0.4F * routes.indexOf(route)),
                            0.4F,
                            0.3F,
                            0.3F,
                            0,
        ...
        MainRenderer.scheduleRender(CIRCLE, false,
                ...
                (graphicsHolderNew, offset) -> {
					...
					for (ArrayList<Object> route : routes) {
						IDrawing.drawStringWithFont(graphicsHolderNew, (String) route.get(1), HorizontalAlignment.CENTER, VerticalAlignment.CENTER, -0.4F + (0.4F * routes.indexOf(route)), 0.55F, 0.2F, 0.2F, 0.05F, ARGB_WHITE, false, light, null);
					}
