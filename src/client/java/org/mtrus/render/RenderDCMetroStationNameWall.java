...
public class RenderDCMetroStationNameWall extends BlockEntityRenderer<BlockDCMetroStationNameWallEntity> implements IGui {
    ...
    public RenderDCMetroStationNameWall(BlockEntityRenderer.Argument dispatcher) {
        super(dispatcher);
        MTRUSAddon.LOGGER.info("RenderDCMetroStationNameWall constructor called");
    }

    @SuppressWarnings("deprecation")
	@Override
    public void render(BlockDCMetroStationNameWallEntity entity, float tickDelta,
