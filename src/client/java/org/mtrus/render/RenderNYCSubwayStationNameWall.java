...
public class RenderNYCSubwayStationNameWall extends BlockEntityRenderer<BlockNYCSubwayStationNameWallEntity> implements IGui {
    ...
    public RenderNYCSubwayStationNameWall(BlockEntityRenderer.Argument dispatcher) {
        super(dispatcher);
    }

	@Override
    public void render(BlockNYCSubwayStationNameWallEntity entity, float tickDelta,
