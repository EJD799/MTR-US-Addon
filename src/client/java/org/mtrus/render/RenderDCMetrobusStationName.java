...
public class RenderDCMetrobusStationName extends BlockEntityRenderer<BlockDCMetrobusStationNameEntity> implements IGui {
    ...
    public RenderDCMetrobusStationName(BlockEntityRenderer.Argument dispatcher) {
        super(dispatcher);
    }

	@Override
    public void render(BlockDCMetrobusStationNameEntity entity, float tickDelta,
