...
public class RenderDCMetroLCDPIDS extends PIDSRenderer<BlockDCMetroLCDPIDSEntity> {
    @SuppressWarnings("deprecation")
    public RenderDCMetroLCDPIDS(Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void renderPIDS(BlockDCMetroLCDPIDSEntity blockEntity, PIDSPresetBase pidsPreset, GraphicsHolder graphicsHolder, StoredMatrixTransformations storedMatrixTransformations, World world, BlockState state, BlockPos pos, Direction facing, LongImmutableList targetPlatformIds, ObjectArrayList<ArrivalResponse> arrivals, float tickDelta, boolean[] rowHidden, int light) {
