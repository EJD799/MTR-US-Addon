...
public class RenderOBJDoubleVerticalBlock extends BlockEntityRenderer<OBJDoubleVerticalBlockEntity> {

    @SuppressWarnings("deprecation")
    public RenderOBJDoubleVerticalBlock(BlockEntityRenderer.Argument dispatcher) {
        super(dispatcher);
    }

    @Override
    public void render(
            OBJDoubleVerticalBlockEntity entity,
            float tickDelta,
        ...
        if (IBlock.getStatePropertySafe(state, OBJDoubleVerticalBlock.HALF) == DoubleBlockHalf.LOWER) {
            ...
            if (!(blockObject instanceof OBJDoubleVerticalBlock block)) {
                return;
            }
            ...
            MainRenderer.scheduleRender(
                    ...
                    (graphicsHolderNew, offset) -> {
                        ...
                        Direction facing = IBlock.getStatePropertySafe(state, OBJDoubleVerticalBlock.FACING);
    ...
    @Override
    public boolean rendersOutsideBoundingBox2(OBJDoubleVerticalBlockEntity entity) {
        return true;
    }
